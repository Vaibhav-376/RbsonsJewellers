    ...
    const navItems = [
        {
            ...
            featured: false,
            submenu: [
                { name: "Wedding Rings", href: "/rings/wedding" },
                { name: "Engagement Rings", href: "/rings/engagement" },
                { name: "Fashion Rings", href: "/rings/fashion" },
                { name: "Couple Band", href: "/rings/fashion" },
                { name: "Gents Rings", href: "/rings/statement" },
                { name: "Gents Diamond Rings", href: "/rings/statement" },
                { name: "Gents Solitaire Rings", href: "/rings/statement" },
                { name: "Ladies Rings", href: "/rings/vintage" },
                { name: "Ladies Antique Rings", href: "/rings/vintage" },
                { name: "Ladies Cocktail Rings", href: "/rings/vintage" },
                { name: "Ladies Polki Rings", href: "/rings/vintage" },
            ]
        },
        {
            name: "Earrings",
