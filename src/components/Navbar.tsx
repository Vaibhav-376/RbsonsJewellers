...
const Navbar = () => {
    ...
    return (
        <>
            {isNavigating && (
                <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-[#31135E]/95 via-[#2A0E52]/95 to-[#31135E]/95 backdrop-blur-md flex items-center justify-center">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between gap-2 sm:gap-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <Link href="/" className="flex items-center group" onClick={(e) => handleNavigation(e, "/")}>
                                <div className="relative">
                                    <Image
                                        src="/Logo.png"
                                        alt="Company Logo"
